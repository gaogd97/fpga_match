...
HD_PWD='G:/k7325_676/2_mig/03_img_camera/img_camera_ov5640_720p/mig_ddr.runs/ms_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ms_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ms_fifo.tcl
