...
//-------------------------位置、频率计算--------------------------------
wire [7:0] h1,h2,l1,l2;
wire [15:0] h3,h4,l3,l4;
...
assign L_mode1 = L;
assign H_output = (mode == 1'b0)? (H_mode1 * h1 /h2 +h3-h4):(H_mode2 * h1 /h2 +h3-h4);
assign L_output = (mode == 1'b0)? (L_mode1 * l1 /l2 +l3-l4):(L_mode2 * l1 /l2 +l3-l4);
//--------------------  电机频率计算--------------------------------------------
...
//----------------------------电机驱动--------------------------------------
wire monitor_ok;
wire [15:0] forth_pulse_num;
wire [15:0] back_pulse_num;
wire [15:0] freq_out;
