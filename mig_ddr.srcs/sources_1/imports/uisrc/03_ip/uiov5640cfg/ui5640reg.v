...
begin
	case(REG_INDEX)
	 ...
	 36:        REG_DATA<=24'h362201; // 50/60Hz detection     50/60Hz 
	 ...
	 59:        REG_DATA<=24'h5000a7; // Lenc on, raw gamma on, BPC on, WPC on, CIP on // AEC target    
	 60:        REG_DATA<=24'h3a0f30;// stable range in high
	 61:        REG_DATA<=24'h3a1028;// stable range in low
	 62:        REG_DATA<=24'h3a1b30;// stable range out high
	 63:        REG_DATA<=24'h3a1e26;// stable range out low
	 64:        REG_DATA<=24'h3a1160;// fast zone high
	 65:        REG_DATA<=24'h3a1f14;// fast zone low// Lens correction for 
	 ...
	 127:       REG_DATA<=24'h583dce;// lenc BR offset // AWB    
	 ...
	 158:       REG_DATA<=24'h519e38;// AWB control // Gamma  
	 ...
	 175:       REG_DATA<=24'h54901d;// color matrix    
	 ...
	 186:       REG_DATA<=24'h538b98; // sign[8:1] // UV adjust   UV 
	 ...
	 193:       REG_DATA<=24'h501d40;// enable manual offset of contrast// CIP   
	 ...
	 //680x480 30喔多竵/喔｀箣, night mode 5fps, input clock =24Mhz, PCLK =56M 
	 //set OV5640 to video mode 720p 
	 208:       REG_DATA<=24'h303541;// PLL     input clock =24Mhz, PCLK =84Mhz 21
	 209:       REG_DATA<=24'h303669;// PLL
	 210:       REG_DATA<=24'h3c0707; // lightmeter 1 threshold[7:0]
	 211:       REG_DATA<=24'h382043; // flip
	 212:       REG_DATA<=24'h382105; // mirror
	 213:       REG_DATA<=24'h381431; // timing X inc
	 214:       REG_DATA<=24'h381531; // timing Y inc
	 ...
	 223:       REG_DATA<=24'h380805; // DVPHO     (1280)
	 224:       REG_DATA<=24'h380900; // DVPHO     (1280)
	 225:       REG_DATA<=24'h380a02; // DVPVO     (720)
	 226:       REG_DATA<=24'h380bd0; // DVPVO     (720)
	 227:       REG_DATA<=24'h380c07; // HTS
	 228:       REG_DATA<=24'h380d64; // HTS
	 229:       REG_DATA<=24'h380e02; // VTS
	 230:       REG_DATA<=24'h380fe4; // VTS
	 231:       REG_DATA<=24'h381304; // timing V offset
	 232:       REG_DATA<=24'h361800;
	 233:       REG_DATA<=24'h361229;
	 234:       REG_DATA<=24'h370952;
	 235:       REG_DATA<=24'h370c03;
	 236:       REG_DATA<=24'h3a0202; // 60Hz max exposure
	 237:       REG_DATA<=24'h3a03e0; // 60Hz max exposure
	 238:       REG_DATA<=24'h3a1402; // 50Hz max exposure
	 239:       REG_DATA<=24'h3a15e0; // 50Hz max exposure
	 240:       REG_DATA<=24'h400402; // BLC line number
	 241:       REG_DATA<=24'h30021c; // reset JFIFO, SFIFO, JPG
	 242:       REG_DATA<=24'h3006c3; // disable clock of JPEG2x, JPEG
	 243:       REG_DATA<=24'h471303; // JPEG mode 3
	 244:       REG_DATA<=24'h440704; // Quantization sacle
	 245:       REG_DATA<=24'h460b37;
	 246:       REG_DATA<=24'h460c20;
	 247:       REG_DATA<=24'h483716; // MIPI global timing
	 248:       REG_DATA<=24'h382404; // PCLK manual divider
	 249:       REG_DATA<=24'h500183; // SDE on, CMX on, AWB on
...
//	 301:       REG_DATA<=24'h3b070a; //FREX strobe mode1	
	 ...
	 //300:REG_DATA<=24'h503d82;            //REG_DATA<=24'h503d80; test pattern selection control, 80:color bar,00: test disable
